...
export const returnStatusConfig: Record<ReturnStatus, { label: string; icon: LucideIcon; color: string; progress: number }> = {
...
export const trackingStatusConfig: Record<TrackingStatus, { label: string; icon: LucideIcon; color: string }> = {
